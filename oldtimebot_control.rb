...
#I may have been defeated trying to work this on windows
...
Daemons.run_proc('oldtimebot.rb', options) do
  stopped = false
      ...
      consumer_key = OAuth::Consumer.new(
       ...
       access_token = OAuth::Token.new(
        ...
        request.set_form_data(
          "status" => "#{tweet_data[0]} (#{bill_year}), an act to #{tweet_data[1]} laws.leg.mt.gov/legprd/#{tweet_data[2]} #pastmtleg",
              )
